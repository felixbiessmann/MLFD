package de.metanome.algorithms.hyfd.config;
...
public class Config {
	...
	public enum Dataset {
		...
		NCVOTER_STATEWIDE, NCVOTER_STATEWIDE_10K, NCVOTER_STATEWIDE_100K, NCVOTER_STATEWIDE_1M,
		...
		TPCH, ADDRESS, PAPERS, PAPERAUTHORAFFILIATION,
		LINEITEM, POLY_SEQ, ZBC00DT, PLANETS
	}
	
	private Dataset defaultDataset = Dataset.NCVOTER_STATEWIDE_10K;//PLANETS;//
	...
	public String statisticsFileName = "FD_statistics.txt";
	public String resultFileName = "FD_results.txt";
	
	public boolean writeResults = true;
	
	public boolean nullEqualsNull = true;
	public boolean validateParallel = true;
	public boolean enableMemoryGuardian = true;
	public int maxDeterminantSize = -1;
	...
	public void setDataset(Config.Dataset dataset) {
		switch (dataset) {
			...
			case NCVOTER_STATEWIDE_100K:
				...
				this.inputFileHasHeader = true;
				break;
			case NCVOTER_STATEWIDE_1M:
				this.inputDatasetName = "ncvoter_Statewide_1024001r_71c";
				this.inputFileSeparator = ',';
				this.inputFileHasHeader = true;
				break;
			case TPCH:
				this.inputDatasetName = "tpch";
				this.inputFileSeparator = ',';
				this.inputFileHasHeader = true;
				break;
			case ADDRESS:
				this.inputDatasetName = "address";
				this.inputFileSeparator = ',';
				this.inputFileHasHeader = true;
				break;
			case PAPERS:
				this.inputDatasetName = "Papers";
				this.inputFileSeparator = '\t';
				this.inputFileHasHeader = false;
				break;
			case PAPERAUTHORAFFILIATION:
				this.inputDatasetName = "PaperAuthorAffiliations";
				this.inputFileSeparator = '\t';
				this.inputFileHasHeader = false;
				break;
			case LINEITEM:
				this.inputDatasetName = "lineitem";
				this.inputFileSeparator = ';';
				this.inputFileHasHeader = false;
				break;
			case POLY_SEQ:
				this.inputDatasetName = "PDBX_POLY_SEQ_SCHEME";
				this.inputFileSeparator = ';';
				this.inputFileHasHeader = false;
				break;
			case ZBC00DT:
				this.inputDatasetName = "ZBC00DT_COCM";
				this.inputFileSeparator = ',';
				this.inputFileHasHeader = false;
				break;
			case PLANETS:
